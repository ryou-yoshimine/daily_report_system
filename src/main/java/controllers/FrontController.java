...
public class FrontController extends HttpServlet {
    ...
    /**
     * @see HttpServlet#doPost(HttpServletRequest request, HttpServlet response response)
     */
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" }) // コンパイラ警告を抑制
        ...
        try{
            ...
            //ActionBaseのブジェクトにキャスト(例:actions.EmployeeActionオブジェクト→actions.ActionBaseオブジェクト)
